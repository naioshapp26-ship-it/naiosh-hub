...
(() => {
  ...
  const KNOWLEDGE = [
    ...
    {
      keys: ['منصة', 'منصات', 'platform', 'حاضنة', 'بحث', 'search'],
      reply:
        'استخدم محرك البحث الشامل من الزر الأبيض في الهيرو (محرك البحث الشامل) للبحث في الحاضنات والمنصات والأنظمة بالاسم أو التصنيف أو الكود.',
      links: [{ href: 'index.html', label: 'الصفحة الرئيسية — محرك البحث' }, { href: 'platforms.html', label: 'المنصات' }, { href: 'incubators.html', label: 'الحاضنات' }],
    },
    {
