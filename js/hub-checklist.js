...
(() => {
  ...
  const CORE_ITEMS = [
    ...
    { id: 'c13', label: 'مركز معلومات نايوش هوب — السياسات والتشغيل', status: 'done', href: 'hub-checklist.html', hrefLabel: 'مركز المعلومات' },
    ...
    { id: 'c52', label: 'مركز تدريب وتعليم واكتساب المهارات', status: 'partial', href: 'hub-checklist.html#guides', hrefLabel: 'دليل الاستخدام' },
    ...
    { id: 'c61', label: 'الذكاء الاصطناعي للحلول التشغيلية', status: 'partial', href: 'hub-checklist.html', hrefLabel: 'مركز المعلومات' },
