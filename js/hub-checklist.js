...
(() => {
  ...
  const ITEMS = [
    ...
    { id: 'c20', label: 'غرفة العمليات · الصيانة والدعم الفني', status: 'partial', href: 'dashboard.html', hrefLabel: 'غرفة العمليات' },
    ...
    { id: 'c25', label: 'الدخول المباشر لفرع المستأجر', status: 'partial', href: 'branches.html', hrefLabel: 'الفروع' },
    ...
    { id: 'c29', label: 'الدخول المباشر لمكتب موظفي المنصة', status: 'missing', href: null, hrefLabel: null },
    ...
    { id: 'c32', label: 'الدخول المباشر لصفحة الشراكات', status: 'missing', href: null, hrefLabel: null },
    { id: 'c33', label: 'الدخول المباشر لقائمة عملاء المستأجر', status: 'partial', href: 'systems/crm.html', hrefLabel: 'CRM' },
    { id: 'c34', label: 'الدخول المباشر لمنصة دورات المستأجر', status: 'partial', href: 'systems/lms.html', hrefLabel: 'دورات المستأجر' },
    { id: 'c35', label: 'الدخول المباشر لمنصة دبلومات المستأجر', status: 'partial', href: 'systems/academy.html', hrefLabel: 'دبلومات المستأجر' },
    { id: 'c36', label: 'الدخول المباشر للدردشة الخاصة بالمستأجر', status: 'partial', href: 'chat.html', hrefLabel: 'دردشة المستأجر' },
    { id: 'c37', label: 'سلة المشتريات من متاجر الإمبراطورية', status: 'partial', href: 'store.html', hrefLabel: 'المتجر' },
    ...
    { id: 'c41', label: 'ربط الفروع بالحاضنات والمنصات في بيئة واحدة', status: 'partial', href: 'operating.html', hrefLabel: 'آلية التشغيل' },
    ...
    { id: 'c47', label: 'استوديو التسويق الإلكتروني', status: 'missing', href: 'ads.html', hrefLabel: 'التسويق' },
    ...
    { id: 'c50', label: 'طلب المساعدة المفتوحة من جميع الأعضاء', status: 'partial', href: 'dashboard.html', hrefLabel: 'طلب مساعدة' },
    ...
    { id: 'c66', label: 'المهام التنفيذية لجميع المستخدمين', status: 'partial', href: 'dashboard.html', hrefLabel: 'المهام' },
    { id: 'c67', label: 'إصدار التقارير الرقابية وقياس الأداء', status: 'partial', href: 'dashboard.html', hrefLabel: 'التقارير الرقابية' },
    { id: 'c68', label: 'مؤشر الاختناقات وإيجاد الحلول', status: 'missing', href: null, hrefLabel: null },
