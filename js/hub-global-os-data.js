...
(() => {
  ...
  const layers = [
    ...
    { id: 'id', n: 2, en: 'Identity & Access', ar: 'الهوية والصلاحيات', desc: 'هوية نايوش · الدخول الموحد · الصلاحيات حسب الدور والسياق · سياق الكيان' },
    { id: 'ops', n: 3, en: 'Core Operations', ar: 'التشغيل المؤسسي', desc: 'سير العمل · الطلبات · المهام · الوثائق · التدقيق' },
    ...
    { id: 'int', n: 6, en: 'Integration Hub', ar: 'التكامل', desc: 'واجهات البرمجة · الأحداث · خطافات الويب · المزامنة' },
    { id: 'data', n: 7, en: 'Data & Knowledge', ar: 'البيانات والمعرفة', desc: 'تشغيلي · تحليلي · سياسات · دروس مستفادة' },
    { id: 'mkt', n: 8, en: 'Marketing & CRM', ar: 'التسويق والعملاء', desc: 'حملة ← عميل محتمل ← علاقات العملاء ← بيع ← عائد' },
  ...
  const coreServices = [
    ...
    'محرك لوحة المستخدم',
    'محرك القوائم والتنقل',
    'محرك سير العمل',
    'محرك الإشعارات',
    'محرك المهام',
    'محرك الوثائق والأرشيف',
    'العضوية والشهادات',
    'الاشتراكات والباقات',
    'محرك النقاط والاستهلاك',
    'محرك الدفع',
  ...
  const executionOrder = [
    ...
    { n: 2, title: 'التسجيل الموحد وهوية نايوش', desc: 'التسجيل والهوية الموحدة' },
    { n: 3, title: 'الدخول الموحد (SSO)', desc: 'دخول موحّد لجميع الأنظمة' },
    { n: 4, title: 'محرك المؤسسات والمستأجرين', desc: 'دول → فروع → حاضنات → منصات → مكاتب → مستأجرين' },
    { n: 5, title: 'الأدوار والصلاحيات', desc: 'الأدوار ومصفوفة الصلاحيات' },
    { n: 6, title: 'المكوّنات التشغيلية المشتركة', desc: 'سير العمل · مهام · إشعارات · وثائق · نقاط · دفع · تقارير · تدقيق' },
    { n: 7, title: 'نواة هوب 360', desc: 'مركز التشغيل والتوجيه' },
    { n: 8, title: 'مركز التكامل وواجهات البرمجة وناقل الأحداث', desc: 'الجهاز العصبي للمنظومة' },
  ...
  const aiLevels = [
    { id: 'assistant', n: 1, title: 'AI Assistant', ar: 'المساعد الذكي', desc: 'يجيب عن الأسئلة ضمن الصلاحيات.' },
    { id: 'analyst', n: 2, title: 'AI Analyst', ar: 'المحلل الذكي', desc: 'يفهم البيانات ويشرح الأسباب.' },
    { id: 'advisor', n: 3, title: 'المستشار الذكي', ar: 'المستشار الذكي', desc: 'يقدّم توصيات قابلة للاعتماد.' },
    { id: 'predictor', n: 4, title: 'AI Predictor', ar: 'نظام التنبؤ', desc: 'يتوقع الأداء والطلب والمخاطر.' },
    { id: 'orchestrator', n: 5, title: 'AI Orchestrator', ar: 'منسّق العمليات الذكي', desc: 'ينسّق العمليات المصرّح بها مع إشراف بشري.' },
  ];

  const erpLayers = [
    { n: 1, title: 'الحوكمة والإدارة', items: ['لوحة تحكم', 'أدوار', 'سياسات', 'هيكل', 'أرشفة', 'مستأجرين', 'طلبات', 'اشتراك سحابي'] },
    { n: 2, title: 'الموارد البشرية', items: ['منظومة الأفراد 360', 'حضور', 'رواتب', 'أداء', 'تدريب', 'مواهب'] },
    { n: 3, title: 'المالية والدفع', items: ['حسابات', 'فواتير', 'تحصيل', 'بنوك', 'ميزانيات', 'نقاط'] },
    { n: 4, title: 'المبيعات والعملاء', items: ['إدارة علاقات العملاء', 'عروض', 'عقود', 'نقاط البيع', 'عمولات'] },
    ...
    { n: 8, title: 'البيانات والتحليل والأتمتة', items: ['مركز البيانات', 'مؤشرات الأداء', 'المستشار الذكي', 'اختناقات'] },
  ];

  const cycle = ['PLAN', 'REQUEST', 'APPROVAL', 'EXECUTE', 'RECORD', 'FINANCE', 'MEASURE', 'ANALYZE', 'AI', 'DECIDE', 'IMPROVE'];

  const events = [
    { code: 'Student.Registered', systems: ['LMS', 'إدارة علاقات العملاء', 'Points'] },
    { code: 'Course.Completed', systems: ['LMS', 'Knowledge', 'AI'] },
    { code: 'Invoice.Created', systems: ['Finance', 'إدارة علاقات العملاء', 'ERP'] },
    { code: 'Payment.Received', systems: ['Finance', 'Points', 'إدارة علاقات العملاء', 'Notifications', 'Analytics'] },
    { code: 'Campaign.Created', systems: ['Marketing', 'Ads', 'Analytics'] },
    { code: 'Lead.Created', systems: ['إدارة علاقات العملاء', 'Sales', 'Marketing'] },
    ...
    { code: 'Opportunity.Matched', systems: ['Opportunity', 'Learning', 'إدارة علاقات العملاء'] },
  ...
  const dataDictionary = [
    { entity: 'عميل', owner: 'إدارة علاقات العملاء', type: 'أساسي', readers: ['Sales', 'Finance', 'Marketing', 'Support'], writers: ['إدارة علاقات العملاء'] },
    { entity: 'موظف', owner: 'HR', type: 'أساسي', readers: ['Facility', 'Safety', 'Training', 'ERP'], writers: ['HR'] },
    { entity: 'منتج/خدمة', owner: 'Catalog', type: 'أساسي', readers: ['Store', 'Marketing', 'Finance', 'إدارة علاقات العملاء'], writers: ['Catalog', 'ERP'] },
    { entity: 'مورد', owner: 'Supply', type: 'أساسي', readers: ['Finance', 'Facility', 'Procurement'], writers: ['Supply'] },
    { entity: 'فرع', owner: 'Organization', type: 'أساسي', readers: ['All'], writers: ['Organization'] },
    { entity: 'حاضنة', owner: 'Organization', type: 'أساسي', readers: ['All'], writers: ['Organization'] },
    { entity: 'منصة', owner: 'Organization', type: 'أساسي', readers: ['All'], writers: ['Organization'] },
    { entity: 'مكتب', owner: 'Organization', type: 'أساسي', readers: ['All'], writers: ['Organization'] },
    { entity: 'طالب/متدرب', owner: 'LMS', type: 'أساسي', readers: ['إدارة علاقات العملاء', 'Academy', 'Finance'], writers: ['LMS', 'Academy'] },
    { entity: 'أصل', owner: 'Assets/Facility', type: 'أساسي', readers: ['Finance', 'HR', 'Ops'], writers: ['Assets'] },
    { entity: 'Contract', owner: 'Legal/ERP', type: 'أساسي', readers: ['Finance', 'Sales', 'HR'], writers: ['Legal', 'ERP'] },
    { entity: 'فاتورة', owner: 'Finance', type: 'معاملة', readers: ['إدارة علاقات العملاء', 'Sales', 'Analytics'], writers: ['Finance'] },
    { entity: 'دفعة', owner: 'Finance/Points', type: 'معاملة', readers: ['إدارة علاقات العملاء', 'Analytics', 'Wallet'], writers: ['Finance', 'Points'] },
    { entity: 'NAIOSH ID', owner: 'Identity', type: 'أساسي', readers: ['All'], writers: ['Identity'] },
    { entity: 'كائن معرفة', owner: 'Knowledge', type: 'مشتق', readers: ['AI', 'All'], writers: ['Knowledge', 'Systems'] },
  ];
  ...
  const systems = [
    ...
    mk(35, 'إدارة علاقات العملاء', 'إدارة علاقات العملاء', 2, 'Growth', 'عملاء · فرص · متابعة', 'systems/crm.html', { hub: true, erp: true, crm: true, marketing: true, ai: true, knowledge: true, data: true, workflow: true }, 87),
