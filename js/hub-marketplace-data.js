(() => {
  ...
  const APPS = [
    ...
    { code: 'LAW', nameAr: 'نايوش لو — النظام القانوني', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=LAW', icon: 'fa-gavel', status: 'active' },
    { code: 'NAIS', nameAr: 'نايس — ذكاء التشغيل', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=NAIS', icon: 'fa-chart-line', status: 'active' },
    { code: 'FIT', nameAr: 'نايوش فيت — الصحة واللياقة', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=FIT', icon: 'fa-dumbbell', status: 'active' },
    { code: 'ERP', nameAr: 'نايوش إي آر بي', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=ERP', icon: 'fa-sitemap', status: 'active' },
    { code: 'ACADEMY', nameAr: 'أكاديمية نايوش', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=ACADEMY', icon: 'fa-chalkboard-user', status: 'active' },
    ...
    { code: 'LMS', nameAr: 'نظام التعلم', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=LMS', icon: 'fa-laptop-code', status: 'active' },
    { code: 'CRM', nameAr: 'إدارة علاقات العملاء', kind: 'system', category: 'أنظمة نايوش', url: 'system-portal.html?code=CRM', icon: 'fa-handshake', status: 'building' },
  ];
