(() => {
  const PAGE_GUIDES = {
    ...
    sideProjects: {
      ...
      subtitle: 'NAIOSH SIDE BUSINESS HUB — نموذج فتح واقتراح وتشغيل.',
      purpose: 'املأ النموذج، احصل على أفضل 10 مشاريع مناسبة، وتصفّح كتالوج القوائم الـ١٤ من ملفات العميل، ثم افتح مشروعك.',
      tips: [
        'ابدأ بنموذج فتح المشروع في أعلى الصفحة.',
        'لكل مشروع: رأس المال · المهارات · العملاء · الإيرادات · خطة 30 يومًا.',
        '«فتح المشروع» يحفظه في مشاريعي المفتوحة ويربطك بمسار CRM والتسويق والتدريب.',
      ],
    },
    platforms: {
    ...
    ads: {
      ...
      purpose: 'رفع إعلان حسب المستوى (مكتب/منصة/حاضنة/فرع) مع خيارات العرض ومكان الظهور على الواجهة الرئيسية لكل مستوى.',
      tips: [
        'اختر المستوى التشغيلي أولًا — يحدد نوع الإعلان تلقائيًا.',
        'خيارات العرض: الواجهة الرئيسية + المكاتب/المنصات/الحاضنات/الفروع.',
        'مكان الظهور: الصفحة الرئيسية لكل مستوى.',
        'الإعلانات تظهر تلقائيًا على الرئيسية والفروع والحاضنات والمنصات وصفحة المكتب.',
      ],
    },
    events: {
