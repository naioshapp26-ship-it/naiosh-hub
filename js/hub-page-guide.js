(() => {
  const PAGE_GUIDES = {
    home: {
      ...
      tips: [
        'تحت الهيرو مباشرة: معرض منتجات نايوش هوب — مرّر أفقياً بين اللقطات.',
    ...
    products: {
      ...
      title: 'دليل عرض المنتجات',
      subtitle: 'جدول المنتجات: بحث · علامة · سعر · مخزون · حركة.',
      purpose: 'عرض كتالوج المنتجات المرتبط بالمنصات — رؤية لحظية للمخزون والمبيعات والحركة.',
      tips: [
        'ابحث بالاسم أو الرمز أو العلامة أو المنصة.',
        'فلتر حسب العلامة التجارية والتصنيف والحالة.',
        'من كل صف يمكنك فتح الإعلان أو الشراء من المتجر.',
      ],
    },
    store: {
      test: (path) => path.includes('store'),
      title: 'دليل متجر المبيعات',
      subtitle: 'بيع منتجات المنصات وباقات التشغيل.',
      purpose: 'متجر مبيعات نايوش داخل هوب مع ربط بالنقاط وإعلانات المنتجات.',
      tips: ['اشترِ منتجًا بالنقاط أو السعر.', 'لعرض الجدول الكامل افتح صفحة المنتجات.'],
    },
    ads: {
