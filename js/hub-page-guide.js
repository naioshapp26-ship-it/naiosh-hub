  ...
  const PAGE_GUIDES = {
    home: {
      ...
      tips: [
        ...
        'الشريط الجانبي حسب الدليل: فرعي/حاضنتي/منصتي/مكتبي للخاص بك فقط، قناتي للفيديو، دوراتي ودبلوماتي لبرامجك، وطلبات المشاريع للإدارة.',
    ...
    sideProjects: {
      ...
      subtitle: 'رحلة واضحة من اختيار الفكرة إلى متابعة المشروع.',
      purpose:
        'اختر نوع المشروع، ابحث عن فكرة، اضغط «ابدأ مشروعك»، أكمل البيانات أو احفظ مسودة، ثم راجع وأرسل وتابع الحالة من «مشاريعي».',
      tips: [
        'ابدأ بزر «كيف أبدأ؟» أو راجع «رحلة مشروعك» لمعرفة الخطوة الحالية.',
        'اختر النوع أولًا ثم الفكرة، ثم اضغط «ابدأ مشروعك».',
        'يمكنك حفظ مسودة والعودة لاحقًا من قسم «مشاريعي».',
        'إذا طلبت الإدارة تعديلًا سيظهر السبب مع زر إعادة الإرسال.',
      ],
    },
    globalOs: {
    ...
    ads: {
      ...
      title: 'دليل إدارة الإعلانات',
      subtitle: 'تشغيل إعلانات متعدد الطبقات داخل هوب.',
      purpose: 'رفع إعلان حسب المستوى مع اختيار مشروع من فئات نايوش (خاصة · خفيفة · منزلية) ثم خيارات العرض والحفظ.',
      tips: [
        'اختر المستوى التشغيلي أولًا — يحدد نوع الإعلان تلقائيًا.',
        'في قسم المشاريع: اختر الفئة ثم مشروعك من كتالوج نايوش.',
        'بعد الحفظ يظهر اسم المشروع على بطاقة الإعلان.',
        'خيارات العرض: الواجهة الرئيسية + المكاتب/المنصات/الحاضنات/الفروع.',
      ],
    },
    events: {
