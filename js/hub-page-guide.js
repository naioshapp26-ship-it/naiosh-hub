  ...
  const PAGE_GUIDES = {
    ...
    dashboard: {
      ...
      tips: [
        ...
        'زر الرجوع أسفل الصفحة يعيدك للصفحة السابقة أو الرئيسية.',
      ],
    },
    platforms: {
    ...
    products: {
      ...
      tips: [
        'اختر تصنيفاً من الشريط العلوي أو من قائمة التصنيفات.',
        'كل بطاقة عليها أزرار: تعديل · تعيين · حذف · أرشفة.',
        'زر إضافة أعلى الصفحة لإدخال منتج جديد.',
      ],
    },
    store: {
