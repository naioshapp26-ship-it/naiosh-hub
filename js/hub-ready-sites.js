...
(() => {
  ...
  const READY_SITES = [
    ...
    {
      id: 'side-projects',
      nameAr: 'مشاريع جانبية — SIDE BUSINESS HUB',
      tag: 'مشاريع',
      desc: 'نموذج فتح مشروع جانبي مع اقتراح أفضل الفرص من كتالوج العميل وتشغيل داخل هوب.',
      href: 'side-projects.html',
      icon: 'fa-seedling',
      tone: 'academy',
      inProducts: true,
      inGallery: true,
      sidebar: { label: 'مشاريع جانبية', icon: 'fa-seedling' },
      preview: [
        { icon: 'fa-clipboard-list', label: 'النموذج' },
        { icon: 'fa-lightbulb', label: 'الاقتراح' },
        { icon: 'fa-rocket', label: 'التشغيل' },
      ],
      kpi: [
        { b: '١٤', s: 'قائمة' },
        { b: '١٠', s: 'اقتراحات' },
