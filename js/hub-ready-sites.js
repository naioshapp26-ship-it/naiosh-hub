...
(() => {
  ...
  const READY_SITES = [
    ...
    },
    {
      ...
      nameAr: 'نظام الأرشفة',
      tag: 'وثائق',
      desc: 'أرشفة وتصنيف وبحث للمستندات — ادخل مباشرة.',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-box-archive', label: 'أرشفة' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'نظام الأرشفة',
      barSub: 'وثائق هوب',
    },
    {
      id: 'marketing-studio',
      nameAr: 'استديو الحملات التسويقية',
      tag: 'تسويق',
      desc: 'شغّل الحملات من استوديو الإعلانات فورًا.',
      href: 'ads.html',
      launchCode: 'ADS',
      live: true,
      icon: 'fa-bullhorn',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-bullhorn', label: 'حملات' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'الحملات التسويقية',
      barSub: 'استوديو هوب',
    },
    {
      id: 'events-studio',
      ...
      tag: 'فعاليات',
      desc: 'تذاكر وبث واستضافة — ادخل استوديو الفعاليات.',
      href: 'events.html',
      launchCode: 'EVENTS',
      live: true,
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-calendar-days', label: 'فعاليات' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'الفعاليات',
      barSub: 'استوديو هوب',
    },
    {
      id: 'teachers',
      nameAr: 'مركز المعلمين',
      tag: 'تعليم',
      desc: 'أدوات المعلم والمحتوى والشهادات — ادخل مباشرة.',
      href: 'courses.html',
      launchCode: 'TEACHERS',
      live: true,
      icon: 'fa-chalkboard-user',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-chalkboard-user', label: 'معلمون' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'مركز المعلمين',
      barSub: 'دورات هوب',
    },
    {
      id: 'automation',
      nameAr: 'الإنترنت والأتمتة',
      tag: 'تشغيل',
      desc: 'أتمتة التشغيل من آلية هوب — ادخل مباشرة.',
      href: 'operating.html',
      launchCode: 'AUTOMATION',
      live: true,
      icon: 'fa-globe',
      tone: 'erp',
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-globe', label: 'أتمتة' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'الأتمتة',
      barSub: 'تشغيل هوب',
    },
    {
      ...
      tag: 'تشغيل',
      desc: 'تشغيل المرافق من خدمات هوب — ادخل مباشرة.',
      href: 'services.html',
      launchCode: 'FACILITIES',
      live: true,
      icon: 'fa-building',
      tone: 'hub',
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-building', label: 'مرافق' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'المرافق',
      barSub: 'خدمات هوب',
    },
    {
      id: 'supply',
      nameAr: 'سلاسل التوريد',
      tag: 'لوجستيات',
      desc: 'توريد وشحن من خدمات هوب — ادخل مباشرة.',
      href: 'services.html',
      launchCode: 'SUPPLY',
      live: true,
      icon: 'fa-truck',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-truck', label: 'توريد' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'سلاسل التوريد',
      barSub: 'خدمات هوب',
    },
    {
      id: 'safety-inc',
      nameAr: 'حاضنة السلامة',
      tag: 'سلامة',
      desc: 'حاضنة السلامة والصحة المهنية — ادخل الحاضنات.',
      href: 'incubators.html',
      launchCode: 'SAFETY_INC',
      live: true,
      icon: 'fa-helmet-safety',
      tone: 'fit',
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-helmet-safety', label: 'سلامة' }],
      kpi: [{ b: 'حي', s: 'هوب' }],
      bar: 'حاضنة السلامة',
      barSub: 'الحاضنات',
    },
    {
      ...
      tag: 'إي آر بي',
      desc: 'وحدة الموارد البشرية — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      icon: 'fa-users',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-users', label: 'موارد' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'الموارد البشرية',
      barSub: 'نايوش إي آر بي',
    },
    {
      id: 'erp-finance',
      nameAr: 'القوائم والتقارير المالية',
      tag: 'إي آر بي',
      desc: 'القوائم والتقارير المالية — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-file-invoice-dollar', label: 'مالية' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'التقارير المالية',
      barSub: 'نايوش إي آر بي',
    },
    {
      id: 'erp-purchase',
      nameAr: 'المشتريات والطلبات',
      tag: 'إي آر بي',
      desc: 'المشتريات والطلبات — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-cart-flatbed', label: 'شراء' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'المشتريات',
      barSub: 'نايوش إي آر بي',
    },
    {
      ...
      tag: 'إي آر بي',
      desc: 'إدارة الموظفين — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      icon: 'fa-id-badge',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-id-badge', label: 'موظفون' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'الموظفون',
      barSub: 'نايوش إي آر بي',
    },
    {
      ...
      nameAr: 'المهام',
      tag: 'إي آر بي',
      desc: 'المهام والمتابعة — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      icon: 'fa-list-check',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-list-check', label: 'مهام' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'المهام',
      barSub: 'نايوش إي آر بي',
    },
    {
      ...
      nameAr: 'نظام الدفع',
      tag: 'إي آر بي',
      desc: 'نظام الدفع والتحصيل — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      icon: 'fa-credit-card',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-credit-card', label: 'دفع' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'نظام الدفع',
      barSub: 'نايوش إي آر بي',
    },
    {
      ...
      nameAr: 'المبيعات',
      tag: 'إي آر بي',
      desc: 'المبيعات والعروض — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-cash-register', label: 'بيع' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'المبيعات',
      barSub: 'نايوش إي آر بي',
    },
    {
      id: 'erp-collect',
      nameAr: 'الدعم والتحصيل',
      tag: 'إي آر بي',
      desc: 'الدعم والتحصيل — ادخل إي آر بي فورًا.',
      href: 'https://web-production-419e2.up.railway.app/',
      launchCode: 'ERP',
      live: true,
      icon: 'fa-headset',
      ...
      inProducts: true,
      inGallery: false,
      preview: [{ icon: 'fa-headset', label: 'تحصيل' }],
      kpi: [{ b: 'حي', s: 'ERP' }],
      bar: 'الدعم والتحصيل',
      barSub: 'نايوش إي آر بي',
    },
    ...
    {
      id: 'my-channel',
      nameAr: 'قناتي — قناة الفيديو الخاصة',
      tag: 'قناة',
      desc: 'قناتك الخاصة لرفع الفيديوهات وربط يوتيوب أو أي منصة اجتماعية.',
      href: 'my-channel.html',
      icon: 'fa-video',
      tone: 'hub',
      inProducts: true,
      inGallery: true,
      sidebar: { label: 'قناتي', icon: 'fa-video' },
      preview: [
        { icon: 'fa-video', label: 'فيديو' },
        { icon: 'fa-link', label: 'رابط' },
        { icon: 'fa-share-nodes', label: 'سوشيال' },
      ],
      kpi: [
        { b: '١', s: 'قناة' },
        { b: '∞', s: 'فيديو' },
    ...
    },
    {
      ...
      nameAr: 'دوراتي',
      tag: 'تعليم',
      desc: 'دوراتك الخاصة فقط — الكتالوج العام يبقى في صفحة الدورات.',
    ...
    },
    {
      ...
      nameAr: 'دبلوماتي',
      tag: 'تعليم',
      desc: 'دبلوماتك الخاصة فقط — الكتالوج العام يبقى في صفحة الدبلومات.',
      href: 'my-diplomas.html',
      icon: 'fa-graduation-cap',
      tone: 'academy',
      inProducts: true,
      inGallery: true,
  ...
  const siteForProduct = (item = {}) => {
    ...
    const map = {
      ...
      تعليم: 'edusmartx',
      مناهج: 'edunaiosh',
      'نظام الأرشفة': 'archive',
      'استديو الحملات التسويقية': 'marketing-studio',
      'استوديو الفعاليات': 'events-studio',
      'مركز المعلمين': 'teachers',
      'الإنترنت والأتمتة': 'automation',
      'إدارة المرافق': 'facilities',
      'سلاسل التوريد': 'supply',
      'حاضنة السلامة': 'safety-inc',
      'إدارة العملاء CRM': 'crm',
      'الموارد البشرية': 'erp-hr',
      'القوائم والتقارير المالية': 'erp-finance',
      'المشتريات والطلبات': 'erp-purchase',
      'إدارة الموظفين': 'erp-employees',
      المهام: 'erp-tasks',
      'نظام الدفع': 'erp-pay',
      المبيعات: 'erp-sales',
      'الدعم والتحصيل': 'erp-collect',
    };
    const id = map[cat];
