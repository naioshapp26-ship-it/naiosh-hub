...
(() => {
  ...
  const READY_SITES = [
    ...
    {
      id: 'side-projects',
      nameAr: 'المشاريع الجانبية — SIDE PROJECTS',
      tag: 'فرص',
      desc: 'نظام اتخاذ قرار لاكتشاف فرص الدخل: تحليل الملف، اقتراح، مخاطر، متطلبات، واختبار صغير ثم تشغيل داخل هوب.',
      href: 'side-projects.html',
      icon: 'fa-lightbulb',
      tone: 'academy',
      inProducts: true,
      inGallery: true,
      sidebar: { label: 'مشاريع جانبية', icon: 'fa-lightbulb' },
      preview: [
        { icon: 'fa-id-card', label: 'الملف' },
        { icon: 'fa-brain', label: 'التحليل' },
        { icon: 'fa-flask', label: 'الاختبار' },
      ],
      kpi: [
        { b: '١٤', s: 'قاعدة' },
        { b: '١٠', s: 'فرص' },
      ],
      bar: 'المشاريع الجانبية',
      barSub: 'SIDE PROJECTS',
    },
    {
      id: 'side-project-registrations',
      nameAr: 'طلبات تسجيل المشاريع — ADMIN INBOX',
      tag: 'تشغيل',
      desc: 'صندوق داخلي لاستقبال طلبات تسجيل المشاريع الجانبية ومتابعة أصحاب المشاريع والتواصل عبر الجوال أو الإيميل.',
      href: 'side-project-registrations.html',
      icon: 'fa-inbox',
      tone: 'ops',
      inProducts: false,
      inGallery: true,
      sidebar: { label: 'طلبات المشاريع', icon: 'fa-inbox' },
      preview: [
        { icon: 'fa-inbox', label: 'استقبال' },
        { icon: 'fa-phone', label: 'تواصل' },
        { icon: 'fa-clipboard-check', label: 'متابعة' },
      ],
      kpi: [
        { b: 'طلب', s: 'جديد' },
        { b: 'فريق', s: 'متابعة' },
      ...
      bar: 'طلبات التسجيل',
      barSub: 'SIDE PROJECT INBOX',
    },
    {
      id: 'global-os',
      nameAr: 'نظام التشغيل العالمي — GLOBAL OS',
      tag: 'معمارية',
      desc: 'المعمارية المرجعية · سجل الأنظمة الـ41 · Integration Hub · AI Gateway · قاموس البيانات · توجيه المبرمجين.',
      href: 'global-os.html',
      icon: 'fa-network-wired',
      tone: 'erp',
      inProducts: true,
      inGallery: true,
      sidebar: { label: 'نظام التشغيل', icon: 'fa-network-wired' },
      preview: [
        { icon: 'fa-sitemap', label: 'طبقات' },
        { icon: 'fa-clipboard-list', label: 'سجل 41' },
