...
(() => {
  ...
  const DEST = {
    ...
    learning: { href: 'hub-checklist.html', title: 'مركز معلومات نايوش هوب', type: 'knowledge', typeAr: 'مركز المعلومات', icon: 'fa-graduation-cap' },
    ...
    infoCenter: { href: 'hub-checklist.html', title: 'مركز معلومات نايوش هوب', type: 'knowledge', typeAr: 'مركز المعلومات', icon: 'fa-circle-info' },
    engineSpecs: { href: 'engine-specs.html', title: 'المواصفات الوظيفية لنايوش هوب', type: 'knowledge', typeAr: 'مركز المعلومات', icon: 'fa-gears' },
    ...
    checklist: { href: 'hub-checklist.html', title: 'مركز معلومات نايوش هوب', type: 'knowledge', typeAr: 'مركز المعلومات', icon: 'fa-list-check' },
